...
declare module "sequelize" {
    ...
    namespace sequelize {
         ...
         * ```js
         *
         * UserAttribute.belongsToMany(Role, { through: UserRole });
         *
         * interface UserInstance extends Sequelize.Instance<UserInstance, UserAttributes>, UserAttributes {
         ...
         *
         * ```js
         * UserAttribute.hasMany(Picture)
         * UserAttribute.belongsTo(Picture, { as: 'ProfilePicture', constraints: false })
         *
         ...
         *
         * ```js
         * UserAttribute.hasMany(Picture, { foreignKey: 'uid' })
         * ```
         *
        ...
        interface Associations {
             ...
             * on the target.
             *
             * Example: `UserAttribute.hasOne(Profile)`. This will add userId to the profile table.
             *
             ...
             * source.
             *
             * Example: `Profile.belongsTo(UserAttribute)`. This will add userId to the profile table.
             *
             * @param target The model that will be associated with hasOne relationship
             * @param options Options for the association
             */
             ...
             * UserAttribute.hasMany(Project)
             * ```
             * ```js
             * // Create a n:m association between user and project
             * UserAttribute.hasMany(Project)
             * Project.hasMany(UserAttribute)
             * ```
             ...
             * })
             * UserAttribute.hasMany(Project, { through: UserProjects })
             * Project.hasMany(UserAttribute, { through: UserProjects })
             * ```
             * ```js
             ...
             *
             * ```js
             * UserAttribute.belongsToMany(Project)
             * Project.belongsToMany(UserAttribute)
             * ```
             * By default, the name of the join table will be source+target, so in this case projectsusers. This can be
             ...
             *   started: Sequelize.BOOLEAN
             * })
             * UserAttribute.belongsToMany(Project, { through: UserProjects })
             * Project.belongsToMany(UserAttribute, { through: UserProjects })
             * ```
             * ```js
             * jan.addProject(homework, { started: false }) // The homework project is not started yet
	...
	interface FindOptions extends LoggingOptions, SearchPathOptions {
        ...
        interface Model<TInstance, TAttributes> extends Hooks<TInstance>, Associations {
            ...
            all( options? : FindOptions ) : Promise<TInstance[]>;
        ...
        interface Sequelize extends SequelizeStaticAndInstance, Hooks<any> {
             ...
             *   return UserAttribute.find(..., { transaction: t}).then(function (user) {
