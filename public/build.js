...
var base64_url_decode = __webpack_require__(18);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(24), __webpack_require__(19)))
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__FeedComponent_NewPostComponent_vue__ = __webpack_require__(20);
...
/* harmony default export */ exports["default"] = {
    ...
    methods: {
        triggerComments: function triggerComments(index) {
...
// module
exports.push([module.i, "\n.card[data-v-03680cfd]{\n    padding: 25px;\n}\n", "", {"version":3,"sources":["/./components/LoginComponent.vue?cc676f2a"],"names":[],"mappings":";AA2CA;IACA,cAAA;CACA","file":"LoginComponent.vue","sourcesContent":["<script>\n    import Cookies from 'js-cookie'\n    const jwt = require('jwt-decode')\n    \n    export default\n    {\n        template: '#login-component',\n        data() {\n            return {\n                email: '',\n                password: ''\n            }\n        },\n        created() {\n            \n        },\n        methods: {\n            submit(){\n                $.post('', {\n                    email: this.email, \n                    password: this.password\n                }, (res) => {\n                    if(res.success)\n                    {\n                        this.$store.commit('setUser', jwt(res.token))\n                        Cookies.set('token', res.token)\n                        window.location.replace('/')\n                    }\n                    else if(res.message == 'Wrong password')\n                    {\n                        $('#password').addClass('invalid')\n                    }\n                    else\n                    {\n                        $('#email').addClass('invalid')                        \n                    }    \n                })\n            }\n        }  \n    }\n</script>\n\n<style scoped>\n    .card{\n        padding: 25px;\n    }\n</style>\n"],"sourceRoot":"webpack://"}]);
...
// module
exports.push([module.i, "\ntextarea[data-v-59c82843]{\n    margin: 0;\n}\n.collapsible-body[data-v-59c82843]{\n    height: auto;\n    padding: 0 10px 0;\n}\n.row[data-v-59c82843]{\n    padding: 5px 15px 5px;\n    margin-bottom: 0;\n}\n.file-field[data-v-59c82843]{\n    height: 36px;\n    margin-top: 0;\n}\n.file-field .btn[data-v-59c82843]{\n    height: 36px;\n    line-height: 36px;\n}\n.file-field .file-path[data-v-59c82843]{\n    height: 36px;\n}\n", "", {"version":3,"sources":["/./components/FeedComponent/NewPostComponent.vue?636b00b8"],"names":[],"mappings":";AAmCA;IACA,UAAA;CACA;AACA;IACA,aAAA;IACA,kBAAA;CACA;AACA;IACA,sBAAA;IACA,iBAAA;CACA;AACA;IACA,aAAA;IACA,cAAA;CACA;AACA;IACA,aAAA;IACA,kBAAA;CACA;AACA;IACA,aAAA;CACA","file":"NewPostComponent.vue","sourcesContent":["<script>\n    export default {\n        template: '#new-post-component',\n        data(){\n            return {\n                tagsArray:[],\n                content: ''\n            }\n        },\n        methods: {\n            onSubmit(){\n                $.ajax({\n                        method:'POST',\n                        url:'', \n                        data: new FormData($('#new-post-form')[0]),\n                        cache: false,\n                        contentType: false,\n                        processData: false\n                    })\n            }\n        },\n        computed:{\n            tags:{\n                get(){\n                    return this.tagsArray.join(',')\n                },\n                set(tags){\n                    this.tagsArray = tags.split(',')\n                }\n            }\n        }\n    }\n</script>\n\n<style scoped>\n    textarea{\n        margin: 0;\n    }\n    .collapsible-body{\n        height: auto;\n        padding: 0 10px 0;\n    }\n    .row{\n        padding: 5px 15px 5px;\n        margin-bottom: 0;\n    }\n    .file-field{\n        height: 36px;\n        margin-top: 0;\n    }\n    .file-field .btn{\n        height: 36px;\n        line-height: 36px;\n    }\n    .file-field .file-path{\n        height: 36px;\n    }\n</style>\n"],"sourceRoot":"webpack://"}]);
...
// module
exports.push([module.i, "\n.card[data-v-7cb5067e]{\n    padding: 25px;\n}\n", "", {"version":3,"sources":["/./components/RegisterComponent.vue?289772ee"],"names":[],"mappings":";AA0CA;IACA,cAAA;CACA","file":"RegisterComponent.vue","sourcesContent":["<script>\n    export default\n    {\n        template: '#register-component',\n        data() {\n            return {\n                email: '',\n                password: '',\n                nickname: '',\n                confirmPassword: ''\n            }\n        },\n        created() {\n            \n        },\n        methods: {\n            submit(){\n                $.post('', {\n                    email: this.email, \n                    password: this.password,\n                    nickname: this.nickname,\n                    confirmPassword: this.confirmPassword\n                }, (res) => {\n                    if(res.success)\n                    {\n                        window.location.replace('/login')\n                    }\n                    else if(res.message == \"Passwords do not match\")\n                    {\n                        $('#passwordConfirmation').addClass('invalid')\n                    }\n                    else\n                    {\n                        $('#email').addClass('invalid')                        \n                    }    \n                })\n            }\n        }  \n    }\n</script>\n\n<style scoped>\n    .card{\n        padding: 25px;\n    }\n</style>\n"],"sourceRoot":"webpack://"}]);
